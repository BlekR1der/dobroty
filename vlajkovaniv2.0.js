...
var langShinko = {
    ...
    "cs_CZ": {
        ...
        "Defense strength": "Síla obrany",
        "Luck": "Štěstí",
        "Population capacity": "Počet obyvatel",
        "Lower coin costs": "Levnější mince",
        "Haul capacity": "Nosnost",
        "Reduced package costs": "?"
    },
                ...
                if (tempRows[j + 2].children[4].innerText.indexOf(langShinko[game_data.locale]["Vyprodukovaná šlechta"]) > -1) {
                    ...
                    switch (tempRows[j + 2].children[1].innerText.trim()) {
                        case langShinko[game_data.locale]["Produkce surovin"]:
                            ...
                            break;
                        case langShinko[game_data.locale]["Rychlost rekrutace"]:
                            flagPerType["Recruitment speed"] += 1;
                            break;
                        case langShinko[game_data.locale]["Síla útoku"]:
                            flagPerType["Attack strength"] += 1;
                            break;
                        case langShinko[game_data.locale]["Síla obrany"]:
                            flagPerType["Defense strength"] += 1;
                            break;
                        case langShinko[game_data.locale]["Štěstí"]:
                            flagPerType["Luck"] += 1;
                            break;
                        case langShinko[game_data.locale]["Počet obyvatel"]:
                            flagPerType["Population capacity"] += 1;
                            break;
                        case langShinko[game_data.locale]["Levnější mince"]:
                            flagPerType["Lower coin costs"] += 1;
                            break;
                        case langShinko[game_data.locale]["Nosnost"]:
